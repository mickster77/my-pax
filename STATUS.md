...
- phase: Phase 1 — Core extraction + Pax adapter
...
- [P0] [next] Phase 1 — Generic @lab/core (GameDefinition, Policy, RNG, runGame) + paxGame adapter
- [P1] [next] Phase 2 — Strategy lab: batch runner, seat rotation, win-rate/CI stats, CSV out, Pax heuristic policy
...
## Milestones
- [ ] Phase 1 — Core + Pax behind GameDefinition, proven via runGame
- [ ] Phase 2 — Usable strategy lab on Pax
